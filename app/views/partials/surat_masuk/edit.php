                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-Perihal_Surat"  value="<?php  echo $data['Perihal_Surat']; ?>" type="text" placeholder="Enter Perihal Surat"  required="" name="Perihal_Surat"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
