                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-Perihal_Surat"  value="<?php  echo $this->set_field_value('Perihal_Surat',""); ?>" type="text" placeholder="Enter Perihal Surat"  required="" name="Perihal_Surat"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-Asal_Surat"  value="<?php  echo $this->set_field_value('Asal_Surat',USER_ID); ?>" type="text" placeholder="Enter Asal Surat"  required="" name="Asal_Surat"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
