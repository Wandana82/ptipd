...
class Surat_masukController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				surat_masuk.Diterima_oleh LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nomor_Surat","Tanggal_Surat","Perihal_Surat","Asal_Surat","Tanggal_Terima","File_Surat","Diterima_oleh");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_surat","Nomor_Surat","Tanggal_Surat","Perihal_Surat","Asal_Surat","Tanggal_Terima","File_Surat","Diterima_oleh");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Nomor_Surat' => 'required',
